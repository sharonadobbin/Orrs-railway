          ...
          <div class="row">
            ...
            <div class="col-12 col-lg-6 col-xl-4">
              <a href="pass-my-booked-train.php">
                ...
                <div class="chart sparkline custom-icon-background">
    <i class="material-icons custom-icon-color">add_shopping_cart</i>
</div>
                  <div class="data-info">
        ...
        <!--footer-->
        <footer style="background-color: #3d3c3c; color: white; text-align: center; padding: 10px;">
    <p style="font-weight: bold;">DBMS Project by Sharon and Pooja</p>
</footer>
